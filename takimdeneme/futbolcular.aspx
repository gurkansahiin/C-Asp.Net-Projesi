<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="futbolcular.aspx.cs" Inherits="takimdeneme.futbolcular1" %>
    ...
    <form id="form1" runat="server">
         <div class="search-container">
            <asp:TextBox ID="searchInput" runat="server" placeholder="Futbolcu Arayın..."></asp:TextBox>
             ...
             <asp:Button ID="btnListele" runat="server" Text="Listele" CssClass="button" OnClick="btnListele_Click" />
        </div>
...
<%--                <asp:DropDownList ID="dropft1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dropft1_SelectedIndexChanged"></asp:DropDownList>--%>
          ...
          <asp:Button runat="server" ID="btn" Text="Listele" OnClick="Unnamed3_Click"></asp:Button>&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">
<asp:GridView runat="server" ID="gridft"  ></asp:GridView>
