<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="takimdeneme.giris" %>
...
<body>
    <form id="loginForm" runat="server" class="login-form">
        <h1>GİRİŞ</h1>
        <asp:TextBox ID="mail" runat="server" CssClass="tbox" placeholder="Mail adresinizi giriniz"></asp:TextBox>
